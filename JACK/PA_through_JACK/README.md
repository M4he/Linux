...
I still have to investigate this issue and (hopefully) add a fix to this guide as soon as I come up with one. Maybe `pactl unload-module module-suspend-on-idle` will help?